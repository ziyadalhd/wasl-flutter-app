...
import 'package:wasl/features/service_provider/profile/presentation/screens/support_chat_screen.dart';
import 'package:wasl/features/service_provider/profile/presentation/screens/about_us_screen.dart';
import 'package:wasl/features/service_provider/profile/presentation/screens/terms_conditions_screen.dart';

class ServiceProviderSupportScreen extends StatelessWidget {
  const ServiceProviderSupportScreen({super.key});
          ...
          child: FloatingActionButton(
            ...
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      const ServiceProviderSupportChatScreen(),
                ),
              );
            },
            elevation: 4,
                ...
                _buildSupportButton(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            const ServiceProviderAboutUsScreen(),
                      ),
                    );
                  },
                ),
